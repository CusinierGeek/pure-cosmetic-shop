...
axios.default = axios;
const axios$1 = axios;
const BASE_URL$4 = "/api/auth";
async function signIn(data) {
  const response = await axios$1.post(BASE_URL$4, data);
...
async function signOut() {
  await axios$1.delete(BASE_URL$4);
}
const BASE_URL$3 = "/api/users";
async function createUser(partialUser) {
  const response = await axios$1.post(BASE_URL$3, partialUser);
  if (!response.data.error) {
    return response.data;
  } else {
...
async function fetchCurrentUser() {
  var _a;
  const response = await axios$1.get(BASE_URL$3);
...
async function createTemporaryUser() {
  ...
  try {
    ...
    const response = await axios$1.post(`${BASE_URL$3}/temp`, {
...
const BASE_URL$2 = "/api/orders";
async function fetchOrders(customerId) {
  const response = await axios$1.post(BASE_URL$2 + "/history", {
    customerId
  });
  return response.data;
}
async function createOrder(data) {
  const response = await axios$1.post(BASE_URL$2, data);
  return response.data;
}
const BASE_URL$1 = "/api/products";
async function fetchProducts(queryParameters) {
  try {
    const response = await axios$1.get(BASE_URL$1, { params: queryParameters });
    return response.data;
  } catch (error) {
...
async function generateSales(numberOfSales) {
  try {
    const response = await axios$1.get(`${BASE_URL$1}/discount/${numberOfSales}`);
...
async function fetchProductById(productId) {
  try {
    const url = `${BASE_URL$1}/${productId.toString()}`;
...
async function fetchDiscountedPrice(productId) {
  var _a;
  try {
    const response = await axios$1.get(`${BASE_URL$1}/${productId}`);
    return ((_a = response.data.product.discount) == null ? void 0 : _a.discountedPrice) ?? response.data.product.price;
  } catch (error) {
...
async function getCategoryNames() {
  try {
    const response = await axios$1.get(`${BASE_URL$1}/category`);
...
async function getBrandNames() {
  try {
    const response = await axios$1.get(`${BASE_URL$1}/brands`);
...
async function saveCart(userId, subTotal, contents) {
  try {
    const response = await axios$1.post(`${Base_URL}/save`, {
      userId,
      cartData: {
        subTotal,
        contents
...
const postAddress = async (userId, address) => {
  try {
    const response = await axios$1.post(`${API_BASE_URL}`, {
      address,
      userId
    });
    return response.data;
...
const patchAddress = async (userId, address) => {
  try {
    const response = await axios$1.patch(`${API_BASE_URL}`, {
      userId,
      address
    });
    return response.data;
...
const deleteAddress = async (addressId, userId) => {
  try {
    const response = await axios$1.delete(`${API_BASE_URL}`, {
...
async function addCard(card) {
  ...
  const response = await axios$1.post(`${BASE_URL}`, {
    userId,
    card
  });
  if (!response.data.error) {
...
async function deleteCard(cardId) {
  const userStore = useUser();
  const userId = userStore.GetUserId;
  const response = await axios$1.delete(`${BASE_URL}`, {
    data: {
      userId,
      cardId
    }
  ...
  actions: {
    ...
    async addAddress(address) {
      ...
      try {
        ...
        (_a = this.currentUser) == null ? void 0 : _a.addresses.push(response);
        this.error = null;
      } catch (error) {
        this.currentUser = void 0;
        this.error = error;
    ...
    async updateAddress(address) {
      ...
      try {
        ...
        const response = await patchAddress(userId, address);
        const index = (_a = this.currentUser) == null ? void 0 : _a.addresses.findIndex((a) => a._id === response._id);
        if (index !== -1) {
          (_b = this.currentUser) == null ? void 0 : _b.addresses.splice(index, 1, response);
        }
        this.error = null;
      } catch (error) {
        this.currentUser = void 0;
    ...
    async deleteAddress(addressId) {
      var _a;
      try {
        const userId = (_a = this.currentUser) == null ? void 0 : _a._id;
        if (!userId) {
          throw new Error("User not found");
        }
    ...
    async fetchCurrentUser() {
      ...
      try {
        ...
        if (this.currentUser) {
          cartStore.updateCart((_a = this.currentUser) == null ? void 0 : _a.cartState);
        }
        this.error = null;
      } catch (error) {
        this.currentUser = void 0;
...
const useOrder = defineStore("order", {
  ...
  actions: {
    ...
    async createOrder() {
      try {
        const order = await createOrder(this.order);
        this.order = order;
        this.error = null;
        return order;
      } catch (error) {
...
const useOrderHistory = defineStore("orderHistory", {
  state: () => ({
    orders: [],
    error: null
  }),
...
var SortAttributes = /* @__PURE__ */ ((SortAttributes2) => {
  SortAttributes2["PRICE"] = "price";
  SortAttributes2["RATING"] = "rating";
  return SortAttributes2;
})(SortAttributes || {});
...
const useProducts = defineStore("products", {
  ...
  actions: {
    ...
    async generateSales(numberOfSales) {
      try {
    ...
    setFileteredRating(rating) {
      this.filteredRating = rating;
      this.fetchProducts();
    },
    setFilterPriceUpper(upper) {
      this.filterPrice.upper = upper;
      this.fetchProducts();
    },
    setFilterPriceLower(lower) {
    ...
    async fetchDiscountedPrice(productId) {
      try {
...
const useCart = defineStore("cart", {
  ...
  actions: {
    ...
    async calculateSubTotal() {
      ...
      for (const cartItem of this.contents) {
        const product = await fetchProductById(cartItem.productId);
        if ((product == null ? void 0 : product.discount) && (product == null ? void 0 : product.discount.percent) > 0) {
  ...
  routes: [
    {
      path: "/",
      name: "Home",
      component: () => __vitePreload(() => import("./Home-5bb23d35.js"), true ? ["assets/Home-5bb23d35.js","assets/ProductsList-0559ee77.js","assets/SalesRibbon-bceaca1d.js","assets/SalesRibbon-6c5d403b.css","assets/ProductsList-ec598c43.css","assets/Home-9532ef40.css"] : void 0)
    },
    {
      path: "/products/detailed",
      name: "ProductDetailedList",
      component: () => __vitePreload(() => import("./Products-d705a6cf.js"), true ? ["assets/Products-d705a6cf.js","assets/ProductsList-0559ee77.js","assets/SalesRibbon-bceaca1d.js","assets/SalesRibbon-6c5d403b.css","assets/ProductsList-ec598c43.css","assets/Products-29eff4a2.css"] : void 0)
    },
    {
      path: "/products",
      name: "Products",
    ...
    },
    {
      path: "/products/:id",
      name: "Product",
      component: () => __vitePreload(() => import("./Product-f1e617b1.js"), true ? ["assets/Product-f1e617b1.js","assets/BackButton-42076dde.js","assets/BackButton-f1a7ce03.css","assets/SalesRibbon-bceaca1d.js","assets/SalesRibbon-6c5d403b.css","assets/Product-2a102b55.css"] : void 0)
    },
    {
      path: "/cart",
      name: "Cart",
      component: () => __vitePreload(() => import("./Cart-73159af7.js"), true ? ["assets/Cart-73159af7.js","assets/Cart-a73f9822.js","assets/SalesRibbon-bceaca1d.js","assets/SalesRibbon-6c5d403b.css","assets/BackButton-42076dde.js","assets/BackButton-f1a7ce03.css","assets/Cart-608c6029.css","assets/Cart-4552f804.css"] : void 0)
    },
    {
      path: "/profile",
      name: "Profile",
      beforeEnter: [isAuthenticatedGuard],
      component: () => __vitePreload(() => import("./Profile-5a0548ae.js"), true ? ["assets/Profile-5a0548ae.js","assets/CustomInput-2316b695.js","assets/CustomInput-b84eeb16.css","assets/Profile-8b8f9fff.css"] : void 0)
    },
    {
      path: "/login",
      name: "Login",
      beforeEnter: [isNotAuthenticatedGuard],
      component: () => __vitePreload(() => import("./Login-54fde918.js"), true ? ["assets/Login-54fde918.js","assets/CustomInput-2316b695.js","assets/CustomInput-b84eeb16.css","assets/Login-7810bcab.css"] : void 0)
    },
    {
      path: "/register",
      name: "Register",
      beforeEnter: [isNotAuthenticatedGuard],
      component: () => __vitePreload(() => import("./Register-d346a90d.js"), true ? ["assets/Register-d346a90d.js","assets/CustomInput-2316b695.js","assets/CustomInput-b84eeb16.css","assets/Register-2f5be4f5.css"] : void 0)
    },
    {
      path: "/checkout",
      name: "Checkout",
      component: () => __vitePreload(() => import("./Checkout-c95cbeb1.js"), true ? ["assets/Checkout-c95cbeb1.js","assets/CustomInput-2316b695.js","assets/CustomInput-b84eeb16.css","assets/Cart-a73f9822.js","assets/SalesRibbon-bceaca1d.js","assets/SalesRibbon-6c5d403b.css","assets/BackButton-42076dde.js","assets/BackButton-f1a7ce03.css","assets/Cart-608c6029.css","assets/Checkout-956ea833.css"] : void 0)
    },
    {
      path: "/404",
      name: "NotFound",
      component: () => __vitePreload(() => import("./NotFound-f177ef32.js"), true ? [] : void 0)
    },
    {
      path: "/:pathMatch(.*)*",
      name: "NotFound",
...
router.beforeEach(async () => {
  const userStore = useUser();
  if (userStore.currentUser == void 0) {
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const updateSearchTerm = debounce((newQuery) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        withDirectives(createBaseVNode("input", {
          ...
          onKeyup: withKeys(redirect, ["enter"])
...
const SearchBar_vue_vue_type_style_index_0_scoped_e41059a1_lang = "";
...
const searchBar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-e41059a1"]]);
const _hoisted_1$3 = { class: "cartIcon-container" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("a", null, [
          ...
          createBaseVNode("span", {
            class: normalizeClass([{ hidden: !nbOfProducts.value }, "number-icon"])
          }, toDisplayString(nbOfProducts.value), 3)
        ])
      ]);
    };
  }
});
const CartIcon_vue_vue_type_style_index_0_scoped_e190b748_lang = "";
const cartIcon = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e190b748"]]);
const _withScopeId$1 = (n) => (pushScopeId("data-v-f58cae44"), n = n(), popScopeId(), n);
const _hoisted_1$2 = { class: "headerContainer" };
const _hoisted_2$1 = { class: "burger-menu-container" };
const _hoisted_3$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "line" }, null, -1));
const _hoisted_4$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "line" }, null, -1));
const _hoisted_5$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "line" }, null, -1));
const _hoisted_6$1 = [
  _hoisted_3$1,
  _hoisted_4$1,
  _hoisted_5$1
...
const _hoisted_8$1 = { class: "logoContainer" };
const _hoisted_9$1 = {
  key: 2,
  class: "burger-content-link",
  to: "/profile"
};
const _hoisted_10$1 = { class: "searchContainer" };
const _hoisted_11 = { class: "diversContainer" };
const _hoisted_12 = { class: "cart" };
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emit2 }) {
    ...
    const handleClickOutside = (event) => {
      ...
      if (isMenuOpen.value && !document.querySelector(".burger-content").contains(target) && !burgerMenu.contains(target)) {
        closeMenu();
      }
    };
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          nbOfProductsIncart.value ? (openBlock(), createElementBlock("span", _hoisted_7$1, toDisplayString(nbOfProductsIncart.value), 1)) : createCommentVNode("", true)
        ]),
        ...
        createBaseVNode("div", {
          class: normalizeClass(["burger-content", { open: isMenuOpen.value }])
        }, [
          createBaseVNode("span", {
            class: "close-btn",
            onClick: toggleMenu
          ...
          !unref(userStore).isAuthenticated ? (openBlock(), createElementBlock("a", {
            key: 0,
            class: "burger-content-link",
            onClick: _cache[1] || (_cache[1] = ($event) => {
              unref(router).push("/login");
              closeMenu();
            })
          }, [
            createVNode(unref(Icon), {
            ...
            key: 1,
            class: "burger-content-link",
            onClick: _cache[2] || (_cache[2] = ($event) => emit2("signOut"))
          }, [
            createVNode(unref(Icon), {
              icon: "carbon:login",
              class: "icon",
          ...
          unref(userStore).isAuthenticated ? (openBlock(), createElementBlock("a", _hoisted_9$1, [
            createVNode(unref(Icon), {
        ...
        createBaseVNode("div", _hoisted_11, [
          !_ctx.isAuthenticated ? (openBlock(), createBlock(_component_router_link, {
            key: 0,
            class: "divers",
            to: "/login"
          }, {
            ...
            key: 1,
            class: "divers pointer",
            onClick: _cache[7] || (_cache[7] = ($event) => emit2("signOut"))
          }, "LOGOUT")),
          _ctx.isAuthenticated ? (openBlock(), createBlock(_component_router_link, {
            key: 2,
            class: "divers",
        ...
        createBaseVNode("div", _hoisted_12, [
          createVNode(cartIcon, {
            onClick: _cache[8] || (_cache[8] = ($event) => unref(router).push("/cart"))
          })
        ])
      ]);
    };
...
const Header_vue_vue_type_style_index_0_scoped_f58cae44_lang = "";
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-f58cae44"]]);
const _withScopeId = (n) => (pushScopeId("data-v-6b9db35a"), n = n(), popScopeId(), n);
const _hoisted_1$1 = { class: "footer-container" };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", null, "123 Wall Street, NY", -1));
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "follow" }, "FOLLOW US", -1));
const _hoisted_4 = { class: "footer-social-network" };
const _hoisted_5 = {
  href: "#!",
  class: ""
};
...
const _hoisted_10 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "footer-copyright" }, "©2023 THE BUGGER KINGS", -1));
...
const Footer_vue_vue_type_style_index_0_scoped_6b9db35a_lang = "";
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6b9db35a"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(Header, {
          "is-authenticated": unref(userStore).isAuthenticated,
          onSignOut: signOut2,
          class: "header"
        }, null, 8, ["is-authenticated"]),
...
const App_vue_vue_type_style_index_0_scoped_c93c9484_lang = "";
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c93c9484"]]);
...
export {
  ...
  useRoute as K,
  watchEffect as L,
  fetchProductById as M,
  useUser as N,
  withAsyncContext as O,
  useOrderHistory as P,
  Teleport as Q,
  RouterLink as R,
  SortAttributes as S,
  Transition as T,
